...
import com.pulumi.cloudbeaver.TeamArgs;
...
public class Team extends com.pulumi.resources.CustomResource {
    ...
    public Output<Optional<String>> entra_group_id() {
        return Codegen.optional(this.entra_group_id);
    }
    ...
    public Team(java.lang.String name, TeamArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudbeaver:index:Team", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Team(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("cloudbeaver:index:Team", name, null, makeResourceOptions(options, id), false);
    }
