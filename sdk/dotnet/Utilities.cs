...
namespace Pulumi.Cloudbeaver
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/athumi-eu";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Cloudbeaver.version.txt");
    ...
    internal sealed class CloudbeaverResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public CloudbeaverResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
