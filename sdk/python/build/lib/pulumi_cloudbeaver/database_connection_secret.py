...
class DatabaseConnectionSecretArgs:
    def __init__(__self__, *,
                 database_connection_id: pulumi.Input[builtins.str],
                 entra_group_name: pulumi.Input[builtins.str],
    ...
    @property
    @pulumi.getter
    def database_connection_id(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "database_connection_id")

    @database_connection_id.setter
    def database_connection_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "database_connection_id", value)

    @property
    @pulumi.getter
    def entra_group_name(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "entra_group_name")

    @entra_group_name.setter
    def entra_group_name(self, value: pulumi.Input[builtins.str]):
...
class DatabaseConnectionSecret(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 database_connection_id: Optional[pulumi.Input[builtins.str]] = None,
                 entra_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter
    def database_connection_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "database_connection_id")

    @property
    @pulumi.getter
    def entra_group_name(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "entra_group_name")
