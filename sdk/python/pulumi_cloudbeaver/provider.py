...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] api_key: The cloudbeaver API key to use.
        :param pulumi.Input[_builtins.str] endpoint: The cloudbeaver endpoint to connect to.
        """
...
@pulumi.type_token("pulumi:providers:cloudbeaver")
