...
class DatabaseConnectionSecretArgs:
    def __init__(__self__, *,
                 database_connection_id: pulumi.Input[_builtins.str],
                 entra_group_name: pulumi.Input[_builtins.str],
    ...
    @_builtins.property
    @pulumi.getter
    def database_connection_id(self) -> pulumi.Input[_builtins.str]:
        return pulumi.get(self, "database_connection_id")

    @database_connection_id.setter
    def database_connection_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "database_connection_id", value)

    @_builtins.property
    @pulumi.getter
    def entra_group_name(self) -> pulumi.Input[_builtins.str]:
        return pulumi.get(self, "entra_group_name")

    @entra_group_name.setter
    def entra_group_name(self, value: pulumi.Input[_builtins.str]):
...
@pulumi.type_token("cloudbeaver:index:DatabaseConnectionSecret")
class DatabaseConnectionSecret(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 database_connection_id: Optional[pulumi.Input[_builtins.str]] = None,
                 entra_group_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def database_connection_id(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "database_connection_id")

    @_builtins.property
    @pulumi.getter
    def entra_group_name(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "entra_group_name")
